...
export default function VehiculoCard() {
    ...
    const handleSubmit = () => {
        ...
        axios.patch(`http://localhost:8090/reparacion/modificarListo/${id}/${fecha_sal}/${hora_sal}`)
            .then(response => {
    ...
    const handleSubmit2 = () => {
        ...
        axios.patch(`http://localhost:8090/reparacion/modificarSalida/${id}/${fecha_sal}/${hora_sal}`)
            .then(response => {
                console.log("Se editó la reparación Listo", response.data);
    ...
    useEffect(() => {
        axios.get('http://localhost:8090/reparacion/listar')
            .then(response => {
